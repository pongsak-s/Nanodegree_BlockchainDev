...
contract StarNotary is ERC721, ERC721Full {
    ...
    constructor() public ERC721Full("Udacity Crypto Star", "UCS") {
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require( ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "the sender should be the owner of the token" );
        ...
        // approve(msg.sender, _tokenId1);
        // approve(msg.sender, _tokenId2);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require( msg.sender == ownerOf(_tokenId), "the sender should be the owner of the star");
